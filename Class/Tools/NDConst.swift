...
import UIKit
/**    通知     **/
let kNotificationClickUser = "kNotificationClickUser"     //点击用户

/** 请求成功 */
let kSucceed = "succeed"

/** 请求失败 */
let kFailer = "Failer"

/** 是否登陆 */
let strisLogin = "isLogin"

/** 广告图片 */
let AdImage_Name = "AdImage_Name"

//广告链接
let AdImage_Link = "AdImage_Link"
